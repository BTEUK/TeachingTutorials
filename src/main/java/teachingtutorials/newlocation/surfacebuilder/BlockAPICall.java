...
public class BlockAPICall {
    public static BTEDymaxionProjection projections = new BTEDymaxionProjection();
...
//    public static String directory = UK121.directory + "Elevation/";
    ...
    public void getGeneralTileFigures() throws OutOfProjectionBoundsException {
    ...
    public void loadPicture()
    {
        ...
        boolean bDownloaded = apiService.downloadImage(url, xTile, yTile, zoom);

        file = apiService.file;
    ...
    public static int getTileAndHeightForXZ(int X, int Z) throws OutOfProjectionBoundsException {
        xBlock = X;
        yBlock = Z;
    ...
    public static double[] convertMCCordsToLongLat(double iX, double iZ) throws OutOfProjectionBoundsException {
  ...
  //      File file = new File(directory + zoom +"-" + xTile + "-" + yTile + ".png");
    ...
    public static int[] getTile(double x, double y) throws OutOfProjectionBoundsException
    {
