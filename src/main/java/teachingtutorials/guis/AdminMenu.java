...
public class AdminMenu
{
    ...
    public static Inventory getGUI (User u)
    {
        ...
        {
            Utils.createItem(inventory, Material.BOOKSHELF, 1, 12,(ChatColor.GREEN +"Set Compulsory Tutorial"), ChatColor.DARK_GREEN+"Admins only");
            ...
            Utils.createItem(inventory, Material.BOOKSHELF, 1, 16,(ChatColor.GREEN +"Create Tutorial"), ChatColor.DARK_GREEN+"Create a new tutorial in game");
        }
